...
import static io.kpax.e2e.es.config.JacksonConfiguration.ISO_DATE_OPTIONAL_TIME;
import static io.kpax.e2e.es.config.JacksonConfiguration.ISO_FIXED_FORMAT;
